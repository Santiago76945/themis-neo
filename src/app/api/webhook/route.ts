...
/**
 * Handler de webhook MP:
 * - Verifica cabecera x-secret-token
 * - Consulta pago
 * - Acredita monedas según metadata
 */
        ...
        try {
            ...
            if (payment.status === "approved") {
                ...
                if (uid && credit > 0) {
                    ...
                    console.log(`✅ Acreditadas ${credit} ThemiCoins a uid=${uid}. Nuevo saldo:`, user?.coinsBalance);
                } else {
